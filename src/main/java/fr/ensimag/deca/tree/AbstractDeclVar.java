...
public abstract class AbstractDeclVar extends Tree {
    ...
    /**
     * Generates the code for the initializations of global variables.
     * @param compiler
     * @param index
     * @param register
     */
    protected abstract void codeGenDeclVar(DecacCompiler compiler, int index, Register register);
}
