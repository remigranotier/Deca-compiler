...
public class DecacErrorListner implements ANTLRErrorListener {
    ...
    public void reportAmbiguity(Parser recognizer, DFA dfa, int startIndex, int stopIndex, boolean exact, BitSet ambigAlts, ATNConfigSet configs) {
        //System.out.println("Ambiguity detected from " + startIndex + " to " + startIndex + " ; between this set of rules : " + configs.configs);
        System.out.println("Ambiguity detected. Ambiguous input : "
                + recognizer.getTokenStream().getText(recognizer.getTokenStream().get(startIndex),
                recognizer.getTokenStream().get(stopIndex)) + " ; located between index " + startIndex + " and " + stopIndex);
    }

    @Override
    public void reportAttemptingFullContext(Parser recognizer, DFA dfa, int startIndex, int stopIndex, BitSet conflictingAlts, ATNConfigSet configs) {
        //System.out.println("Conflict detected from " + startIndex + " to " + startIndex + " ; between this set of rules : " + configs.configs);
        System.out.println("Conflict detected, attempting full context. Problematic input : "
                + recognizer.getTokenStream().getText(recognizer.getTokenStream().get(startIndex),
                recognizer.getTokenStream().get(stopIndex)) + " ; located between index " + startIndex + " and " + stopIndex);
