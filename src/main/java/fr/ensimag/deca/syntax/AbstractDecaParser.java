...
public abstract class AbstractDecaParser extends Parser {
    ...
    /**
     * Sets the location of Tree to a specified location. Useful in parser for asm method body location.
     * @param tree
     * @param location
     */
    protected void setLocation(Tree tree, Location location) {
    ...
    /**
     * Sets the location of Tree to BUILTIN. Useful in parser for Object type.
     * @param tree
     */
    protected void setLocationBUILTIN(Tree tree) {
